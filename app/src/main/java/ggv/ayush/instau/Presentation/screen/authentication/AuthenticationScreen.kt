    ...
    Box(
        ...
        if (authenticationState.isLoading) {
            ...
            AuthenticationForm(
                ...
                userName = authenticationState.userName, // Add this line
                onNameChange = { name ->
                    handleEvent(AuthenticationEvent.userNameChanged(name)) // Add this line
                },
                phoneNumber = authenticationState.phoneNumber, // Add this line
                onPhoneNumberChange = { phoneNumber ->
                    handleEvent(AuthenticationEvent.phoneNumberChanged(phoneNumber)) // Add this line
                }
            )
